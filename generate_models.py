...
def train_price_predictor(hidden_layer_sizes, activation=nn_default["activation"], solver=nn_default["solver"], learning_rate=nn_default["learning_rate"], max_iter=nn_default["max_iter"], tol=nn_default["tol"]):
	data = read_all_data()
	...
	network = MLPRegressor(hidden_layer_sizes=hidden_layer_sizes, activation=activation, solver=solver, learning_rate=learning_rate, max_iter=max_iter, tol=tol)
